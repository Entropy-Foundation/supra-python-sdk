...
- **[`uv`](https://docs.astral.sh/uv/)** – used for packaging and dependency management.

### Installing `uv`

Follow the official [installation guide](https://docs.astral.sh/uv/getting-started/installation/) to install `uv` on your system.
